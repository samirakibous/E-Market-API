...
const userSchema = yup.object().shape({
    ...
    email: yup.string().email("Email non valide").required("L'email est obligatoire").test("unique-email", "Cet email existe déjà", async value => !(await User.findOne({ email: value }))),
